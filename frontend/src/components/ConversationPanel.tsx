        ...
        <div className={`composer voice-composer ${initial ? "composer-entry" : ""}`}>
          ...
          <div className="voice-footer">
            <p className="voice-disclosure">
              Writer speech recognition may use your browser vendor&apos;s speech service. When
              available, Stewart&apos;s spoken replies are generated by Google Cloud; browser speech
